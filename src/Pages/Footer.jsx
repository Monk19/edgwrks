  ...
  return (
    <>
      <div className="maindiv" id="Contact">
        <img
          src="./Logos/Footer/LOGO/LOGO@2x.PNG"
          alt=""
        ...
        <div className="headings">
          ...
          <div className="box3">
            ...
            <span className="footeraboutus">
              About Services Portfolio Careers Contact
            </span>
          </div>
          ...
          <div className="box4">
            ...
            <div className="footericons">
              <img src="./Logos/Footer/facebook/facebook@2x.png" alt="muppa" />
              <img src="./Logos/Footer/google/google@2x.png" alt="muppa" />
              <img
                src="./Logos/Footer/instagram/instagram@2x.png"
                alt="muppa"
              />
              <img src="./Logos/Footer/linkedin/linkedin@2x.png" alt="muppa" />
              <img src="./Logos/Footer/twitter/twitter@2x.png" alt="muppa" />
              <img src="./Logos/Footer/youtube/youtube@2x.png" alt="muppa" />
            </div>
          </div>
        </div>
      </div>
